**Problem**: Given an array of positive integers **arr[]** and a value **sum**, determine if there is a subset of **arr[]** with sum equal to given **sum**. 
...
[Visit GFG](https://www.geeksforgeeks.org/problems/subset-sum-problem-1611555638/1)
